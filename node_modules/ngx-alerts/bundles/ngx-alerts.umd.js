(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('tslib'), require('rxjs'), require('rxjs/internal/operators'), require('@angular/animations'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-alerts', ['exports', '@angular/core', 'tslib', 'rxjs', 'rxjs/internal/operators', '@angular/animations', '@angular/common'], factory) :
    (factory((global['ngx-alerts'] = {}),global.ng.core,global.tslib,null,null,global.ng.animations,global.ng.common));
}(this, (function (exports,core,tslib,rxjs,operators,animations,common) { 'use strict';

    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes} checked by tsc
     */
    var /** @type {?} */ ALERT_CONFIG = new core.InjectionToken('config');
    var AlertService = (function () {
        ...
        function AlertService(config) {
            ...
            this.initConfig();
            this.dispatcher.pipe(operators.scan(this.reducer, []))
        ...
        AlertService.prototype.reducer = function (state$$1, action) {
            if (action.type === 'ADD') {
                var /** @type {?} */ output = tslib.__spread([
                    action.alert
                ], state$$1);
